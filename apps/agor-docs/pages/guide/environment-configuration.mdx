...
![Worktree card showing environment pill with access, start, stop, view logs, and edit controls](/screenshots/worktree_env_pill.png)
...
![Worktree environment configuration modal showing templated Docker Compose commands and port offsets](/screenshots/env_config.png)
...
3. Press **Start** to validate your commands and watch logs in real time.
   ...
   ![Environment log viewer showing live output for start/stop commands](/screenshots/env_logs.png)
