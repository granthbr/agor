...
<div style={{ textAlign: 'center', marginTop: '2rem', marginBottom: '2rem' }}>
  <img src="/logo.png" alt="agor logo - AI agent orchestration platform" style={{ width: '135px', height: '135px', borderRadius: '50%', opacity: 0.9 }} />
</div>
...
- Templated prompts: Use variables like `worktree.issue_url` in your prompts
...
- Powered by templated commands (e.g. `PORT` assignment with worktree variables) to avoid conflicts while parallelizing things
...
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginTop: '24px', marginBottom: '24px' }}>
  <div>
    <img src="/screenshots/conversation_full_page.png" alt="Agor task-centric conversation UI showing AI agent messages, tool calls, and file changes in a structured timeline" style={{ width: '100%', borderRadius: '8px' }} />
    <p style={{ textAlign: 'center', marginTop: '8px', opacity: 0.5 }}><em>Task-centric conversation UI</em></p>
  </div>
  <div>
    <img src="/screenshots/settings_modal.png" alt="Agor settings modal for configuring MCP servers, managing worktrees, and agent preferences" style={{ width: '100%', borderRadius: '8px' }} />
    <p style={{ textAlign: 'center', marginTop: '8px', opacity: 0.5 }}><em>MCP server and worktree management</em></p>
  </div>
  <div>
    <img src="/screenshots/zone_trigger_modal.png" alt="Agor zone trigger modal displaying automated workflow prompts when dragging sessions into board zones" style={{ width: '100%', borderRadius: '8px' }} />
    <p style={{ textAlign: 'center', marginTop: '8px', opacity: 0.5 }}><em>Zone trigger on session drop</em></p>
  </div>
  <div>
    <img src="/screenshots/zone_trigger_config.png" alt="Agor zone trigger configuration interface for setting up kanban-style workflows and automated prompts" style={{ width: '100%', borderRadius: '8px' }} />
    <p style={{ textAlign: 'center', marginTop: '8px', opacity: 0.5 }}><em>Zone trigger configuration</em></p>
  </div>
  <div>
    <img src="/screenshots/env_configuration.png" alt="Agor worktree environment configuration showing Docker compose commands and port management templates" style={{ width: '100%', borderRadius: '8px' }} />
    <p style={{ textAlign: 'center', marginTop: '8px', opacity: 0.5 }}><em>Worktree environment setup</em></p>
  </div>
  <div>
    <img src="/screenshots/create_session_modal.png" alt="Agor create session modal with agent selection options for Claude Code, Codex, and Gemini" style={{ width: '100%', borderRadius: '8px' }} />
    <p style={{ textAlign: 'center', marginTop: '8px', opacity: 0.5 }}><em>Session creation with agent selection</em></p>
  </div>
  <div>
    <img src="/screenshots/baked_in_terminal.png" alt="Agor built-in terminal with automatic worktree context and environment variable injection" style={{ width: '100%', borderRadius: '8px' }} />
    <p style={{ textAlign: 'center', marginTop: '8px', opacity: 0.5 }}><em>Built-in terminal with worktree context</em></p>
  </div>
  <div>
    <img src="/screenshots/onboarding.png" alt="Agor onboarding welcome screen showing team status, recent activity, and quick start guide" style={{ width: '100%', borderRadius: '8px' }} />
