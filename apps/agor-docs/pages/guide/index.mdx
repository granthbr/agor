...
- **One-click environment control** — configure start/stop commands, health endpoints, URLs per repo.
- Run **multiple feature branches in parallel** with their own running apps and auto-managed ports.
